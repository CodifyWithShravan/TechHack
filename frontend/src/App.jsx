          ...
          <div className="mt-auto pt-4 border-t border-[#333]">
            ...
            >
              ...
              <div className="flex-1 overflow-hidden">
                <div className="text-gray-200 font-medium truncate w-32">{userName}</div>
            ...
            <div className="absolute bottom-0 left-0 w-full bg-gradient-to-t from-[#131314] via-[#131314] to-transparent pt-10 pb-6 px-4 z-40">
              <div className="max-w-3xl mx-auto">
                <div className="relative bg-[#1e1f20] rounded-full border border-[#333] focus-within:border-gray-500 focus-within:bg-[#2a2b2e] transition-all shadow-lg flex items-center pr-2">
                  ...
                  <button onClick={() => fileInputRef.current.click()} disabled={isUploading || isLoading} className="pl-4 pr-2 text-gray-400 hover:text-blue-400 transition-colors">
                  ...
                  <div className="flex items-center gap-1">
                     ...
                     <button onClick={() => sendMessage()} disabled={!input.trim() || isLoading} className={`p-2 rounded-full transition-all ${input.trim() ? 'bg-white text-black' : 'text-gray-500 cursor-not-allowed'}`}>
                        <Send size={18} />
                     </button>
                  </div>
                </div>
